    ...
    <div className="bg-lightGray min-h-screen    ">
      <Container className="border-white border-4 border-solid flex">
        ...
        <div className="bg-#424242 flex items-center h-102 mt-6 w-full rounded-3xl relative overflow-hidden">
          ...
          <div className="max-w-lg ml-auto mr-28">
            <div>
        ...
        <div className="relative mt-22 w-full flex">
              ...
              <div className="flex flex-wrap mt-7.5 flex-col md:flex-row">
                ...
                <div className="w-1/2 mt-12.5">
                  ...
                  <p className="text-sm text-5D5D5E leading-4 mt-4">
                    Info@topsecret.com Support@topsecret.com
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-1/2 md:w-1/3 pr-10 ">
            ...
            <button>
              <div className="w-40 h-12 flex justify-center items-center bg-137BFF rounded-md mt-7.5 text-sm text-fff ">
                Отправить
              </div>
            </button>
          </div>
